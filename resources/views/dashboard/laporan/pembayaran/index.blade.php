...
<div class="container-fluid">
            <div class="fade-in">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> LAPORAN PEMBAYARAN 
                    @if(count($data) > 0)
                      ...
                      <table id="table" name="table" class="table table-responsive-sm">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>{{ number_format($data->total_tagihan_ppn) }}</td>
                                <td>{{ $data->metode_pembayaran }}</td>
                                <td>{{ number_format($data->jumlah_pembayaran) }}</td>
                                <td>{{ $data->status }}</td>
                            </tr>
                            @endforeach
                        </tbody>
